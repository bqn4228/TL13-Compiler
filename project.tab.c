...
{
      28,     0,    -1,    20,    29,    16,    31,    17,    -1,    21,
       5,    22,    30,     9,    29,    -1,    -1,    23,    -1,    24,
      -1,    32,     9,    31,    -1,    -1,    33,    -1,    34,    -1,
      36,    -1,    37,    -1,     5,     8,    38,    -1,     5,     8,
      26,    -1,    13,    38,    14,    31,    35,    17,    -1,    15,
      31,    -1,    -1,    18,    38,    19,    31,    17,    -1,    25,
      38,    -1,    39,    -1,    39,    12,    39,    -1,    40,    11,
      40,    -1,    40,    -1,    41,    10,    41,    -1,    41,    -1,
...
{
       0,   133,   133,   140,   146,   149,   150,   153,   154,   157,
     158,   159,   160,   163,   164,   167,   170,   171,   174,   177,
     180,   181,   184,   185,   188,   189,   192,   193,   200,   201
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ASGN", "SC", "OP2", "OP3", "OP4", "IF", "THEN", "ELSE", "BEGIN_STMT",
  "END", "WHILE", "DO", "PROGRAM", "VAR", "AS", "INT", "BOOL", "WRITEINT",
...
#line 133 "project.y"
    {
																(yyval.nPtr) = prog((yyvsp[(2) - (5)].nPtr),(yyvsp[(4) - (5)].nPtr));																
																print_code((yyval.nPtr));
...
#line 140 "project.y"
    {	
											...
											add_ident((yyvsp[(2) - (6)].sVal),(yyvsp[(4) - (6)].sVal));
					
											(yyval.nPtr) = decl((yyvsp[(2) - (6)].sVal),(yyvsp[(4) - (6)].sVal),(yyvsp[(6) - (6)].nPtr));
										  ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 153 "project.y"
    {(yyval.nPtr) = statSeq((yyvsp[(1) - (3)].nPtr), (yyvsp[(3) - (3)].nPtr));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 163 "project.y"
    {(yyval.nPtr) = asgnNode(find_ident((yyvsp[(1) - (3)].sVal)), (yyvsp[(3) - (3)].nPtr), 0);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 164 "project.y"
    {(yyval.nPtr) = asgnNode(find_ident((yyvsp[(1) - (3)].sVal)), NULL, READINT);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 167 "project.y"
    {(yyval.nPtr) = ifNode((yyvsp[(2) - (6)].nPtr), (yyvsp[(4) - (6)].nPtr), (yyvsp[(5) - (6)].nPtr));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 170 "project.y"
    {(yyval.nPtr) = elseNode((yyvsp[(2) - (2)].nPtr));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 174 "project.y"
    {(yyval.nPtr) = whileNode((yyvsp[(2) - (5)].nPtr), (yyvsp[(4) - (5)].nPtr));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 177 "project.y"
    {(yyval.nPtr) = writeNode((yyvsp[(2) - (2)].nPtr));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 181 "project.y"
    {(yyval.nPtr) = expNode((yyvsp[(1) - (3)].nPtr), (yyvsp[(2) - (3)].sVal), (yyvsp[(3) - (3)].nPtr));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 184 "project.y"
    {(yyval.nPtr) = simpExp((yyvsp[(1) - (3)].nPtr), (yyvsp[(2) - (3)].sVal), (yyvsp[(3) - (3)].nPtr));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 188 "project.y"
    {(yyval.nPtr) = term((yyvsp[(1) - (3)].nPtr),(yyvsp[(2) - (3)].sVal),(yyvsp[(3) - (3)].nPtr));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 192 "project.y"
    {(yyval.nPtr) = varNode(find_ident((yyvsp[(1) - (1)].sVal)));;}
    break;
...
#line 193 "project.y"
    {	
					/*ERROR CHECK #3*/
					if((yyvsp[(1) - (1)].iVal) <= -2147483647 && (yyvsp[(1) - (1)].iVal) >= 2147483647){
						yyerror("Integer overflow");
					}
					(yyval.nPtr) = numNode((yyvsp[(1) - (1)].iVal));
			   ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 200 "project.y"
    {(yyval.nPtr) = boolNode((yyvsp[(1) - (1)].bVal));;}
    break;
